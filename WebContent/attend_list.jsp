...
List<Attendance> list=attendanceDao.queryPageList(pagenow);
%>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="list-group">
					...
					<a href="#" class="list-group-item text-center active">考勤记录</a>
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					<div class="panel-heading">考勤列表</div>
